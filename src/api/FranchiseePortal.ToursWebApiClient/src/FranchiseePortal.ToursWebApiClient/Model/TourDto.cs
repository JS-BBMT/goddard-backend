...
namespace FranchiseePortal.ToursWebApiClient.Model
{
    ...
    public partial class TourDto : IEquatable<TourDto>, IValidatableObject
    {
        ...
        /// <param name="scheduledDateTime">scheduledDateTime (required).</param>
        ...
        public TourDto(string id = default(string), string leadId = default(string), string notes = default(string), DateTime scheduledDateTime = default(DateTime), DateTime createdOn = default(DateTime), TourType? type = default(TourType?), string schoolId = default(string), TourStatus? status = default(TourStatus?), string guideId = default(string), TourGuideDto guide = default(TourGuideDto), string classRoom = default(string), FollowUpTimeFrame? followUpTimeFrame = default(FollowUpTimeFrame?), string cancellationReasonId = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "scheduledDateTime", IsRequired = true, EmitDefaultValue = false)]
