...
namespace FranchiseePortal.ToursWebApiClient.Api
{
    ...
    public interface IToursApiSync : IApiAccessor
    {
        ...
        TourDtoPaginationDto ApiV1ToursGet(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        ...
        ApiResponse<TourDtoPaginationDto> ApiV1ToursGetWithHttpInfo(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="FranchiseePortal.ToursWebApiClient.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IToursApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TourDtoPaginationDto> ApiV1ToursGetAsync(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TourDtoPaginationDto>> ApiV1ToursGetWithHttpInfoAsync(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ToursApi : IToursApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TourDtoPaginationDto</returns>
        public TourDtoPaginationDto ApiV1ToursGet(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TourDtoPaginationDto</returns>
        public FranchiseePortal.ToursWebApiClient.Client.ApiResponse<TourDtoPaginationDto> ApiV1ToursGetWithHttpInfo(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TourDtoPaginationDto</returns>
        public async System.Threading.Tasks.Task<TourDtoPaginationDto> ApiV1ToursGetAsync(string schoolId, TourStatus? status = default(TourStatus?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), TourType? type = default(TourType?), string guideName = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
